...
class СactusSprite(pygame.sprite.Sprite):
...
cactus1 = СactusSprite(all_sprites, sheet, road_speed, 600, random.randint(30, 70))
cactus2 = СactusSprite(all_sprites, sheet, road_speed, 600, random.randint(30, 70))
